...
vi.mock("@actalk/inkos-core", async (importOriginal) => {
  ...
  return {
    ...
    listSettlementAttempts: actual.listSettlementAttempts,
    loadSettlementAttempt: actual.loadSettlementAttempt,
    readSettlementEvents: actual.readSettlementEvents,
    readBookConsistently: actual.readBookConsistently,
    ...
    hasFailedOperationOutcomes: actual.hasFailedOperationOutcomes,
    mergeOperationOutcomes: actual.mergeOperationOutcomes,
    operationOutcomesFromToolResult: actual.operationOutcomesFromToolResult,
